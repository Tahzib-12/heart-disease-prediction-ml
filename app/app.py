...
Loads the trained Scikit-Learn pipeline and generates
predictions for new patient data.
"""
...
# heart-disease-prediction/app/models/heart_disease_model.pkl
...
class HeartDiseasePredictor:
    ...
    def predict(
        ...
        # Accept DataFrame input
            ...
            df = patient_data[EXPECTED_COLUMNS].copy()
        ...
        # Convert class into readable label
